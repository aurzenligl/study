...
pag.PAUSE = 0.02
p = pag.position()
pag.moveTo(1760, 1030); pag.rightClick()
pag.moveTo(r6); pag.rightClick()
pag.moveTo(r7); pag.rightClick()
pag.moveTo(1860, 1030); pag.rightClick()
pag.moveTo(p)
